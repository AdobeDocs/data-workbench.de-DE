...
Um den Abruf von Daten von einer [!DNL Repeater] zu einer Zielgruppe zu konfigurieren, müssen Sie die [!DNL Insight Server]Datei bearbeiten, die im [!DNL Replicate.cfg] Ordner auf der Zielgruppe bereitgestellt wird [!DNL Components] [!DNL Insight Server(s)] , wie im folgenden Verfahren beschrieben:

**So konfigurieren Sie den[!DNL Replication Service]auf dem Zielgruppe-Computer**
...
1. Klicken Sie mit der rechten Maustaste auf das Symbol der Zielgruppe, die Sie konfigurieren [!DNL Insight Server] möchten, und klicken Sie auf **[!UICONTROL Server Files]**.
1. Klicken Sie im [!DNL Server Files Manager]Fenster auf , **[!UICONTROL Components]** um den Inhalt der Datei Ansicht. Die [!DNL Replicate.cfg] Datei befindet sich in diesem Ordner.
...
1. Klicken Sie im [!DNL Replicate.cfg] Fenster auf **[!UICONTROL Replicate.cfg]** und dann **[!UICONTROL component]** , um den Inhalt des Fensters Ansicht.
1. Bearbeiten Sie die Parameter mithilfe des folgenden Beispiels und der folgenden Tabelle als Hilfslinien:
   ...
   <tr> 
      ...
      <td colname="col2"> <p>Die Ordner im <span class="wintitle"> Repeater</span> , die in die Zielgruppe <span class="keyword"> Insight Server</span>kopiert (repliziert) werden sollen. Der <span class="wintitle"> Replizierungsdienst</span> ermöglicht die Replizierung mehrerer Ordner aus einem einzigen <span class="wintitle"> Repeater</span>. </p> <p>Um ein neues Verzeichnis hinzuzufügen, klicken Sie mit der rechten Maustaste auf <span class="uicontrol"> Verzeichnisse</span> und klicken Sie auf <span class="uicontrol"> Hinzufügen neuen</span> &gt; <span class="uicontrol"> Verzeichnis</span>. </p> </td> 
   </tr> 
   <tr> 
      ...
      <li id="li_8FDB351102344E3995035557445354BB">Wenn "Rekursiv"den Wert "true"hat und "Flatten Paths"den Wert "false"hat, wird die Ordnerstruktur des Remote-Ordners (<span class="wintitle"> Repeater</span>) exakt im lokalen Pfad auf dem Zielgruppe <span class="keyword"> Insight Server</span>dupliziert. </li>
   ...
   <tr> 
      ...
      <td colname="col2">Der Speicherort der Datenspeicherung für die von <span class="wintitle"> Repeater</span>abgerufenen Dateien. Der Pfad ist relativ zum Installationsordner des <span class="keyword"> Insight-Servers</span> . </td> 
   </tr> 
   <tr> 
   ...
   <tr> 
      ...
      <td colname="col2">Der URI, einschließlich einer Dateimaske, um auf den Dateispeicher des <span class="wintitle"> Repeaters</span> zuzugreifen. Die <span class="filepath"> Datei "Communications.cfg</span> "im <span class="wintitle"> Repeater</span> sollte so konfiguriert sein, dass mit diesem URI auf die Ereignis-Daten zugegriffen werden kann. See <a href="../../../home/c-inst-svr/c-admin-inst-svr/c-mntr-disk-spc/t-mntr-evt-data-spc.md#task-a54d4bd16b96437f943cd09e5d848440"> Monitoring Event Data Space</a>. </td> 
   </tr> 
   <tr> 
      <td colname="col1"> Server </td> 
      <td colname="col2">Parameter für den <span class="wintitle"> Repeater</span> , aus dem der Zielgruppe <span class="keyword"> Insight Server</span> Ereignis-Datendateien abruft. </td> 
   </tr> 
   <tr> 
