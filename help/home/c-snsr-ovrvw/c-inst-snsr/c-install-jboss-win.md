...
Im [!DNL run.bat] -Datei (z. B. C:\jboss-4.0.5.GA\bin\run.bat) die folgenden Zeilen am Ende der Datei direkt vor den &quot;echo&quot;-Zeilen hinzufügen, die dem Startbefehl des JBoss-Servers vorangehen:
