...
1. Erstellen Sie auf Ihrem Tomcat-Server einen Ordner, in dem Sie die Sensor-Programmdateien installieren können. Denken Sie daran, dass sich Ihre Disk-Warteschlange in diesem Verzeichnis befindet. Stellen Sie daher sicher, dass das gewählte Gerät über ausreichend Platz verfügt, um eine Warteschlange von der benötigten Größe zu halten.
...
## Java-Bibliothekspfad ändern {#section-0dae181ef8884f10a57f6cfda8500969}
...
1. Führen Sie im Ordner &quot;bin&quot;den Befehl Tomcat9w.exe (Common Daemon Service Manager) aus.
   ...
   Dabei ist der [!DNL C:\Sensor] Ordner der Ordner, der die [!DNL visual_sciences.dll] Datei enthält.
