...
<table id="table_5FF491A7A6C24E43A06A5C344BF05430"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Legt fest, ob der erste Klick eines neuen Benutzers protokolliert wird, selbst wenn der Benutzer einen Dokumenttyp anfordert, der vom ContentFilterExclude-Parameter herausgefiltert wird. </p> <p>Die Standardeinstellung ist "Nein". </p> <p>Normalerweise werden Bilddateien vom ContentFilterExclude-Parameter herausgefiltert. Wenn LogAllNewUsers auf "yes"gesetzt ist und das erste Dokument, das ein neuer Benutzer vom Server erhält, ein Bild ist, wird diese Anforderung protokolliert. Wenn der Parameter LogAllNewUsers entweder auf "no"oder gar nicht eingestellt ist (und davon ausgegangen wird, dass Bilder vom ContentFilterExclude-Parameter herausgefiltert werden) und das erste Dokument, das ein neuer Benutzer vom Server erhält, ein Bild ist, wird diese Anforderung nicht protokolliert. </p> <p>Beispiel: <span class="filepath"> LogAllNewUsers</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ermöglicht die Deaktivierung der Besucherverfolgung, die zur Einhaltung der Ausschluss-Richtlinien verwendet werden kann. </p> <p>Bei Aktivierung protokolliert <span class="wintitle"> Sensor</span> kein "Paket"für Besucher, deren V1st-Cookie auf die angegebene PrivacyID eingestellt ist. Da für diese Besucher keine Informationen protokolliert werden, werden keine Informationen über diese Besucher zur Verarbeitung an den <span class="keyword"> Data Workbench-Server</span> gesendet. </p> <p>Um diese Funktion zu aktivieren, müssen Sie die folgenden Schritte ausführen: 
