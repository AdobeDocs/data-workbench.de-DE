...
<table id="table_98E135FE4EAF44D6ADEB3C6C1C0BF6A4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die HTTP-Referrer-Zeichenfolge, die vom Client mit der Anfrage an den Server gesendet wird. </p> <p> Beispiel: <span class="filepath"> http://www.mysite.net/cgi-bin/websearch?qry </span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Datum und Uhrzeit (GMT), zu der die Anfrage beim Server empfangen wurde. Die Zeit wird als Anzahl von 100 Nanosekunden seit dem 1. Januar 1600 ausgedrückt. </p> <p> Beispiel: 127710989320000000 wäre der x-timestamp-Wert für 11:28:52.0000000 am Dienstag, den 13. September 2005. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_3B008F1314804A69AE69E8F94908F497"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der gesamte Hostname des Referrers. </p> <p> Beispiel: Wenn cs(referrer) <span class="filepath"> http://my.domain.com/my/page </span> ist, ist cs(referrer-host) <span class="filepath"> my.domain.com </span>. </p> </td> 
  </tr> 
  <tr> 
